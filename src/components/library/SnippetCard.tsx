        ...
        <Group justify="space-between" align="flex-start">
          <Stack gap="xs" style={{ flex: 1 }}>
            <Group gap="xs">
              ...
              {snippet.isFavorite && (
                <IconHeartFilled size={16} style={{ color: 'var(--mantine-color-red-6)' }} />
              )}
            </Group>

            <Group gap="xs">
              {languageIcon && (
                <Image src={languageIcon} alt={snippet.language} width={16} height={16} />
              )}
            ...
            {tags.length > 0 && (
              <Group gap={4}>
                ...
                {tags.length > 3 && <Text size="xs" c="dimmed">+{tags.length - 3} more</Text>}
              </Group>
            )}
          ...
          <Group gap="xs">
            <Tooltip label="Copy code">
              <ActionIcon
                variant="light"
                color="blue"
                onClick={() => onCopyCode(snippet.code)}
              >
                <IconCopy size={16} />
              </ActionIcon>
            </Tooltip>
  ...
  return (
    <Card withBorder shadow="sm" radius="md" p="md" h="100%">
      <Stack gap="xs" h="100%">
        ...
        <Group gap="xs">
          {languageIcon && (
            <Image src={languageIcon} alt={snippet.language} width={14} height={14} />
          )}
